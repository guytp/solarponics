...
{
    public class FruitingBlockFruitingShelfPlaceViewModel : ViewModelBase, IFruitingBlockFruitingShelfPlaceViewModel
    {
        ...
        public FruitingBlockFruitingShelfPlaceViewModel(IDialogBox dialogBox, IFruitingBlockApiClient fruitingBlockApiClient, IShelfApiClient shelfApiClient, IHardwareProvider hardwareProvider, ILoggedInButtonsViewModel loggedInButtonsViewModel, IBannerNotifier bannerNotifier)
        {
        ...
        private async void Confirm()
        {
            ...
            try
            {
                ...
                var fruitingBlock = await this.fruitingBlockApiClient.ShelfPlaceFruiting(this.FruitingBlock.Id, new Models.WebApi.FruitingBlockShelfPlaceRequest
                {
        ...
        private async Task HandleFruitingBlockScan(string barcode)
        {
            ...
            {
                this.dialogBox.Show("Fruiting block must be incubated before fruiting");
                return;
            }

            if (fruitingBlock.FruitingShelfId.HasValue)
            {
                this.dialogBox.Show("Fruiting block has already been placed on fruiting shelf");
                return;
            }
