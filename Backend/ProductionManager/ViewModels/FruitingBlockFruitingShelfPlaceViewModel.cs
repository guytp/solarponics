...
namespace Solarponics.ProductionManager.ViewModels
{
    public class FruitingBlockFruitingShelfPlaceViewModel : ViewModelBase, IFruitingBlockFruitingShelfPlaceViewModel
    {
        ...
        public FruitingBlockFruitingShelfPlaceViewModel(IDialogBox dialogBox, IFruitingBlockApiClient fruitingBlockApiClient, IShelfApiClient shelfApiClient, IHardwareProvider hardwareProvider, ILoggedInButtonsViewModel loggedInButtonsViewModel)
        {
