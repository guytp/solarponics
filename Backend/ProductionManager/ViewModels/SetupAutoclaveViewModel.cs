...
namespace Solarponics.ProductionManager.ViewModels
{
    public class SetupAutoclavesViewModel : ViewModelBase, ISetupAutoclavesViewModel
    {
        ...
        public SetupAutoclavesViewModel(ILoggedInButtonsViewModel loggedInButtonsViewModel, IAutoclaveApiClient apiClient, IDialogBox dialogBox, IHardwareProvider hardwareProvider, ILocationApiClient locationApiClient)
        {
        ...
        private async void Add()
        {
            ...
            try
            {
                ...
                this.dialogBox.Show("Autoclave added.");
            }
            catch (Exception ex)
            {
        ...
        private async void Delete()
        {
            ...
            if (!this.dialogBox.Show("Do you want to delete " + this.SelectedAutoclave.Name + "?", buttons: Enums.DialogBoxButtons.YesNo))
            {
                return;
            }
            ...
            try
            {
                ...
                this.SelectedAutoclave = null;
                this.dialogBox.Show("Autoclave deleted.");
            }
            catch (Exception ex)
            {
